  ...
  <div class="container">
      <div class="row">
          ...
          <div class="col-lg-6 col-12">
              ...
              <div class="row">
                  <div class="col-12">
                      <input type="password" class="w-100 mb-4 p-4" id="validationDefault03" placeholder="{{ __('site.password') }}" required>
                    </div>
                    <div class="col-12">
                      <input type="password" class="w-100 mb-4 p-4" id="validationDefault03" placeholder="{{ __('site.confirm_password') }}" required>
                    </div>
