                    ...
                    <div class="page slidePage">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6 col-12">
                                ...
                                <input type="date" value="{{ $invites->date }}" class="form-control" required>
                            </div>
                            <div class="col-md-6 col-12">
                                <label class="form-label">اسم المناسبة</label>
                                <input type="text" value="{{ $invites->title }}" class="form-control" required>
                            </div>
                            <div class="col-md-6 col-12">
                                <label class="form-label">موقع المناسبة</label>
                                <input type="text" value="{{ $invites->address }}" class="form-control" required>
                            </div>
                            ...
                            <div class="col-lg-8 col-12 d-flex mt-4 justify-content-end">
                                <button class="next-btn main-btn1">تعديل</button>
                            </div>
                        </div>
                    </div>
