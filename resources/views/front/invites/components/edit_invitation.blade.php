    ...
    <div class="section pt-5 pb-5">
        <div class="container">
            ...
            <form id="editForm" class="editForm" method="POST" enctype="multipart/form-data"
                action="{{ route('updateInvitationByClient', $invites->id) }}">
                @csrf
                @method('POST')
                        ...
                        <div class="page slidePage">
                            <div class="">
                                <input name="image" id="image" type="file" class="dropify"
                                    data-default-file="{{ $invites->image }}">
                            </div>
                            <div class="row g-3">

                                <div class="col-md-4 col-12">
                                    <label class="form-label">تاريخ المناسبة</label>
                                    <input type="date" value="{{ $invites->date }}" name="date" class="form-control" id="datepicker">
                                </div>
                                <div class="col-md-4 col-12">
                                    <label class="form-label">اسم المناسبة</label>
                                    <input type="text" value="{{ $invites->title }}" name="title" class="form-control" id="title">
                                </div>

                                <div class="col-md-4 col-12">
                                    <label class="form-label">اختر اللقب</label>
                                    <select name="sur_name" id="sur_name" class="form-control">
                                        <option value="mr/mis" {{ $invites->sur_name == 'mr/mis' ?  'selected' : '' }}>السيد/السيدة</option>
                                        <option value="honored" {{ $invites->sur_name == 'honored' ?  'selected' : '' }}>مكرم</option>
                                    </select>
                                </div>
                                ...
                                <div class="col-md-12 col-12">
                                    ...
                                    <input name="address" id="searchMapInput" type="text"
                                        class="form-control mapControls">
                                    <div id="map"></div>
