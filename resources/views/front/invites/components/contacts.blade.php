    ...
    <div class="container">
        <div class="d-flex justify-content-between">
            ...
            <button type="button" class="main-btn2 bg-hover">
                {{ __('site.points') }}: <span style="margin-right: 8px;">{{ $point }}</span>
            </button>

            <a href="{{ route('addInvites') }}" class="text-decoration-none main-btn1 createBtnInivite">{{ __('site.create_an_invitation') }}</a>
        ...
        <form action="{{ route('searchInvitations')}}">
            <div class="row mt-5" <?php echo $invitations->isEmpty() ? 'hidden' : ''; ?>>
                ...
                <button type="submit" class="text-decoration-none main-btn1">{{ __('site.filter') }}</button>
            </div>
        </form>
        ...
        <div class="card-invite default mt-2" id="dataContainer">
            <button class="btn-faq d-flex justify-content-between align-items-center w-100" data-bs-toggle="collapse" data-bs-target="#collapseExample{{ $invitation->id }}" aria-expanded="false" aria-controls="collapseExample">
                <div class="row" style="width: 50%;">
                    ...
                    <div class="col-lg-4 col-md-6 col-12 d-flex justify-content-center">
                        <p style="{{ $invitation->status == 0 ? 'background-color : #E9EAEB;color: black;' : '' }}" class="btn-active">
            ...
            <div class="collapse" id="collapseExample{{ $invitation->id }}">
                <div class="row mt-4">
                    ...
                    <div class="col-lg-1 col-6 d-flex justify-content-end">
                        <button type="button" class="btn btn-primary fa-solid fa-pen-to-square" id="editBtnInvite" data-id="{{ $invitation->id }}">
                        </button>
                    </div>
                    <div class="col-lg-1 col-6">
                        <div class="delete">
                            <button type="button" class="btn btn-primary fa-solid fa-trash-can" data-toggle="modal" data-target="#exampleModal" data-invitation-id="{{ $invitation->id }}" data-invitation-title="{{ $invitation->title }}"></button>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="scroll confirmed">
                                <table class="table table-striped border">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td colspan="5" class="text-center">{{ trans('site.there_is_no_information') }}
                                            </td>
                                        </tr>
                                        @else
...
<div class="modal fade bd-example-modal-lg" id="editInvite" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
