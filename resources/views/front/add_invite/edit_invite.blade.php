                    ...
                    <div class="page slidePage" id="div1">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-12 col-12">
                                ...
                                <input name="address" value="{{ $invite->address }}" id="searchMapInput" type="text" class="form-control mapControls input-field">
                                <div id="map"></div>
                            ...
                            <div class="col-12 mb-2">
                                <input type="hidden" name="has_qrcode" valu$invite->inviteese="0">
                                <input class="form-check-input" name="has_qrcode" {{ ($invite->has_qrcode == 1) ? 'checked' : '' }} value="1" type="checkbox" id="flexRadioDefault1">
                            ...
                            <div class="col-lg-8 col-12 d-flex mt-4 justify$invite->invitees-content-end">
                                <a href="#" class="text-decoration-none btn-login" id="addDraftInvite" style="background-color: #C7C7C7;"> حفظ فى المسودات</a>
                        ...
                        <div class="scroll">
                            <table class="table border">
                                ...
                                <tbody>
                                    ...
                                    @php
                                    $duplicate = false; // Initialize a flag to check for duplicates

                                    // Check if this email has appeared before
                                    foreach($contacts as $innerIndex => $innerContact) {
                                    if ($innerIndex != $index && $innerContact->email === $contact->email) {
                                    $duplicate = true;
